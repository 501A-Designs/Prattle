                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '0em' }}>
                    ...
                    {messagesThreadArray.length !== 0 && messagesThreadDisplay === false &&
                        <AlignItems arrow={true}>
                            <p style={{cursor:'pointer'}} onClick={()=>setMessagesThreadDisplay(true)}>{messagesThreadArray.length} More in thread</p>
                        </AlignItems>
                    }
                ...
                {user.id === props.roomCreator &&   
                    <>
                        <SmallButton
                            ...
                            title={messagesThreadDisplay === true ? 'Close this thread':'Open a thread'}
                        />
                        <SmallButton
