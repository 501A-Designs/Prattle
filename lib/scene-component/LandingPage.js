      ...
      >
        <div>
          ...
          <div className="grid duoGrid">
            ...
            <Card
              borderRadius={isMobile ? '1em':'1em 0 0 1em'} name="Prattleは違う"
            >
              <p>
            ...
            <Card
              borderRadius={isMobile ? '1em' : '0 1em 1em 0'}
              name="新たな良さ"
            >
              <ul>
                <li>内容に一貫性がある</li>
      ...
      >
        <div>
          ...
          <Card name="お試しください">
            <input
              className={"fullInput"}
              placeholder={'ショートカットを入力してみよう'} onChange={(e)=>{
                e.preventDefault();
                setExampleGhen(e.target.value)
              }}
              value={exampleGhen}
            />
            ...
            >
            {exampleGhen ? 
              <GhenInterpreter inputValue={exampleGhen}/>: <div>
                <h3>他のショートカット</h3>
